...
<html>
<head>
	<title><?php echo !empty($title) ? $title : 'App'; ?></title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/bootstrap/dist/css/bootstrap.min.css') ?>">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('bower_components/bootstrap-submenu/dist/css/bootstrap-submenu.min.css'); ?>">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('bower_components/bootstrap-submenu/dist/css/bootstrap-submenu.min.css.map'); ?>" crossorigin="anonymous">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/sliderPlugin/css/flexslider.css'); ?>" media="screen" />
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/custom.css'); ?>">
</head>
<body>
<div class="container">
	<header class="header">
		<img src="<?php echo base_url('upload/logo.png') ?>" width="150px">
	</header>
